...
DATASETS=("custom-token" "mmlu" "mmlu_tpu" "mlperf" "bench-custom-token" "math500" "bench-custom-mm")
...
if [[ "$DATASET" == "math500" || "$DATASET" == "mmlu" || "$DATASET" == "mmlu_tpu" || "$DATASET" == "mlperf" ]]; then
